...
//        PersonDetailsDTO p = new PersonDetailsDTO("1st user", true);
//        UUID insertedID = personService.insert(p);
//
//        PersonDetailsDTO insertedPerson = new PersonDetailsDTO(insertedID, p.getName(), p.isAdmin());
...
//        PersonDetailsDTO p = new PersonDetailsDTO("2nd user", true);
