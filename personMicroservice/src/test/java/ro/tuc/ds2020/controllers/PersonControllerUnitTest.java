...
//        PersonDetailsDTO personDTO = new PersonDetailsDTO( "John", true);
//
...
//        ObjectMapper objectMapper = new ObjectMapper();
//        PersonDetailsDTO personDTO = new PersonDetailsDTO("john", false);
//
//        mockMvc.perform(post("/person")
//                .content(objectMapper.writeValueAsString(personDTO))
//                .contentType("application/json"))
...
//        ObjectMapper objectMapper = new ObjectMapper();
//        PersonDetailsDTO personDTO = new PersonDetailsDTO( "avvd", false);
//
//        mockMvc.perform(post("/person")
//                .content(objectMapper.writeValueAsString(personDTO))
//                .contentType("application/json"))
